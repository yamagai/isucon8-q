...
func getStats(w http.ResponseWriter, r *http.Request) {
	...
	t := time.Now().Format("20210717_1935")
...
func getEvents(all bool) ([]*Event, error) {
	defer measure.Start("getEvents:all").Stop()
	m := measure.Start("getEvents:part1")
	...
	m.Stop()
	m = measure.Start("getEvents:part2")
	...
	m.Stop()
	m = measure.Start("getEvents:part3")
...
func main() {
	...
	// measure でのプロファイル用エンドポイント
	e.GET("/stats", func(c echo.Context) error {
		getStats(c.Response(), c.Request())
